...
func buildLocalizer(tag string, specs map[string]map[string]string) *Localizer {
	...
	bundle.AddMessages(language.English,
		...
		&i18n.Message{ID: "SuggestionCredentialReauthenticationRequired", Other: "Re-authenticate the selected OAuth or CloudSSO profile with `aliyun configure`, then retry."},
	...
	bundle.AddMessages(language.MustParse("zh-Hans"),
		...
		&i18n.Message{ID: "SuggestionCredentialReauthenticationRequired", Other: "使用 `aliyun configure` 重新认证所选 OAuth 或 CloudSSO profile，然后重试。"},
